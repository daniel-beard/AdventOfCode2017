...
func takeUntilEndOfGarbage(_ input: String) -> String {
	var input = input
	while true {
...
func cleanGarbage(_ input: String) -> String {
	var input = input
	var result = ""
	while true {
		let currChar = String(input.prefix(1))
		...
		if currChar == "<" {
			input = takeUntilEndOfGarbage(input)
		} else {
			result += input.pop(1)
		}
	}
...
let cleanedInput = cleanGarbage(input)
